...
CREATE TABLE IF NOT EXISTS `aquaponics`.`kinds` (
  ...
  `initialtypes_id` INT NOT NULL,
  `description` VARCHAR(45) NULL,
  `modified` DATETIME NULL,
  `created` DATETIME NULL,
  PRIMARY KEY (`id`, `initialtypes_id`),
  INDEX `fk_kinds_initialtypes1_idx` (`initialtypes_id` ASC),
  CONSTRAINT `fk_kinds_initialtypes1`
    FOREIGN KEY (`initialtypes_id`)
...
CREATE TABLE IF NOT EXISTS `aquaponics`.`initials` (
  ...
  CONSTRAINT `fk_initials_kinds1`
    ...
    REFERENCES `aquaponics`.`kinds` (`id` , `initialtypes_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `aquaponics`.`finals`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `aquaponics`.`finals` ;

CREATE TABLE IF NOT EXISTS `aquaponics`.`finals` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `quantity` VARCHAR(45) NULL,
  `unitprice` VARCHAR(45) NULL,
  `initials_id` INT NOT NULL,
  `initials_kinds_id` INT NOT NULL,
  `initials_kinds_initialtypes_id` INT NOT NULL,
  `created` DATETIME NULL,
  `modified` DATETIME NULL,
  PRIMARY KEY (`id`),
